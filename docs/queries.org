# -*- org-adapt-indentation: nil; org-edit-src-content-indentation: 0; orgstrap-cypher: sha256; orgstrap-norm-func-name: orgstrap-norm-func--dprp-1-0; orgstrap-block-checksum: d99bd8d3d6311d21ea02ff4ad82114be6cf97f859b49f3e248345944490c2f50; -*-
...
(when ow-do-packages-emacs
  (cl-letf (((symbol-function 'org-unfontify-region) (lambda (b e)))
            ((symbol-function 'outline-mode) (lambda ()))
            ;; set `outline-mode' to nothing since `cl-letf' fails to
            ;; rebind `unload--set-major-mode' (a native-comp issue?)
            )
...
(let ((ghost "https://raw.githubusercontent.com/tgbugs/orgstrap/"))
  (unless (featurep 'ow)
    (reval 'sha256 'c27d3e298365d1482b80e53b3cb181e960c4a51755d9a48ba9726b1da70c488f
           ;;"~/git/orgstrap/ow.el"
           (concat ghost "9d6e343def3e5acc3debfe59b64fe30edc897311" "/ow.el")))
