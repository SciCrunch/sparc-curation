...
#+header: :var json-string=python-neru-helper(result=cypher-neru-5-helper(neupop_id="ilxtr:neuron-type-keast-10"))
#+header: :var path="./images/neru-simplified-10.svg" :results file
...
[[file:./images/neru-simplified-6.svg]]

[[file:./images/neru-simplified-11.svg]]

[[file:./images/neru-simplified-5.svg]]
...
def query(neupop_id):
    ...
    url = ('http://sparc-data.scicrunch.io:9000/scigraph/dynamic/'
           f'demos/apinat/neru-5/{neupop_id}?limit=9999999')
...
#+call: python-process-neru(result=cypher-neru-5-helper(neupop_id="ilxtr:neuron-type-keast-6"))
