# -*- org-adapt-indentation: nil; org-edit-src-content-indentation: 0; orgstrap-cypher: sha256; orgstrap-norm-func-name: orgstrap-norm-func--prp-1\.1; orgstrap-block-checksum: ce2e93b6a068ab6be3d1d01263d2099f1b80f6f0a8c599bc2ffef23ff342fd5f; -*-
...
5. terms employed in annotation
   ...
   |-----------+-------|
   | sum       |   459 |
   #+TBLFM: @17$2='(+ @1$2..@-2$2);N
   # FIXME will be overwritten on rerun
...
8. Number of neuron populations with external ids and correct subClassOf.
...
9. Number of neuron populations with external ids that match the =neuron-type= pattern.
