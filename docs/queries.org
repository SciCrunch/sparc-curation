# -*- org-adapt-indentation: nil; org-edit-src-content-indentation: 0; orgstrap-cypher: sha256; orgstrap-norm-func-name: orgstrap-norm-func--dprp-1-0; orgstrap-block-checksum: 3d6d927c045317c82f1ff97487fe523c98790ab4629c07cafcb8216f64fb26be; -*-
...
(when ow-do-packages-emacs
  ...
  (let ((no-byte-compile t)) ; prevent byte compile when builtin org defines the macros
    (use-package org))
...
(let ((ghost "https://raw.githubusercontent.com/tgbugs/orgstrap/"))
  (unless (featurep 'ow)
    (reval 'sha256 '253f6bb207993efb2dbc982ba43892ad1cd305b0c27b551fd1e2c8f117cd055c
           ;;"~/git/orgstrap/ow.el"
           (concat ghost "682454fa8d1125ce92771df213d203bca04f4026" "/ow.el")))
