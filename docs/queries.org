# -*- org-adapt-indentation: nil; org-edit-src-content-indentation: 0; orgstrap-cypher: sha256; orgstrap-norm-func-name: orgstrap-norm-func--prp-1\.1; orgstrap-block-checksum: c19e53db0641a181f656073f2016f76552335fc264c1252d842fae5448bd6d09; -*-
...
|          | T1           | bolser-lewis      | x y         |
|          | T1           | keast-bladder     | 20          |
|          | DIENC        | bolser-lewis      | z           |
|          | Diencephalon | keast-bladder     | 15 16 17 18 |
|          | IMG          | keast-bladder     | 3 6 7 11    |
|          | IMG          | sawg-distal-colon | D H G F B Q |
|          | LumSplN      | keast-bladder     | 6 7 11      |
|          | LumSplN      | sawg-distal-colon | B           |
...
"sciatic nerve"
UBERON:0002019 l: "accessory XI nerve"; e: FMA:6720 .
...
UBERON:0001630 l: "muscle organ"; FMA:5022 .
...
;; somehow this gets around lexical scope FIXME no not really
(setq-local
...
(let ((ghost "https://raw.githubusercontent.com/tgbugs/orgstrap/"))
  (unless (featurep 'ow)
    (reval 'sha256 '9683db93bf95cf2c82e7788e9cf26a594e76b19399d7f3d5524900aed5738471
           ;; "~/git/orgstrap/ow.el"
           (concat ghost "a2451655831f09f28301b1e9b4bc74eec5be2d28" "/ow.el")))
...
(unless (fboundp #'ob-cypher/scigraph/query)
  (reval 'sha256 'e630298fa637caff064f500d7c6de7e0a98263796c79cb171f10754d531c3eef
         "https://raw.githubusercontent.com/tgbugs/ob-cypher/9d80fcb193819a6ce7307bb92369b269b4176d43/ob-cypher.el"))
...
(when enable-local-eval ; FIXME HACK how to know when this was called
  ...
  (mapcar (lambda (dblock-name)
            (save-excursion (org-find-dblock dblock-name) (org-cycle)))
          '("properties" "prefixes"))
  (save-excursion
    (goto-char (org-babel-find-named-block "orgstrap-shebang"))
    (org-cycle))
  (goto-char (point-min)))
