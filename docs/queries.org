# -*- org-adapt-indentation: nil; org-edit-src-content-indentation: 0; orgstrap-cypher: sha256; orgstrap-norm-func-name: orgstrap-norm-func--dprp-1-0; orgstrap-block-checksum: e1e7cc627dfa368167d754dad0903f8363ac1c8e26a6821b9cdac9fe3b6864d8; -*-
...
(when ow-do-packages-emacs
  ...
  (cl-loop
   for pkg in '(vterm zmq) do
   (add-to-list 'ow-site-packages pkg))
  (cl-letf (((symbol-function 'org-unfontify-region) (lambda (b e))))
    (ow-enable-use-package nil t))
...
(let ((ghost "https://raw.githubusercontent.com/tgbugs/orgstrap/"))
  (unless (featurep 'ow)
    (reval 'sha256 'bbd6b415953b283ce18a3ce56736c8345bf094e6a5e0b549abe27fb940c1584d
           ;;"~/git/orgstrap/ow.el"
           (concat ghost "54392e3f0748348a79afe4a59524dd9f13b2f1f8" "/ow.el")))
