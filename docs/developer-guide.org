# -*- orgstrap-cypher: sha256; orgstrap-norm-func-name: orgstrap-norm-func--dprp-1-0; orgstrap-block-checksum: 82518384b684c7de1e544da887cfba5f77cf298cdb82f4d7ce4a9b0d10e4260a; -*-
...
def main(path=Path.cwd(), n_jobs=12, extensions=('xml',), **kwargs):
    ...
    if not hasattr(path.cache._remote_class, '_api'):
        path.cache._remote_class.anchorToCache(cache.anchor)
