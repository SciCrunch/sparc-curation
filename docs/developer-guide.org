...
1. [[wt-gh-pull:sparcur/paths.py#L941-L996][entry point to pull]]
   1. [[wt-gh-pull:sparcur/paths.py#L973][the call in pull that actually retrieves data]]
2. [[wt-gh-pull:sparcur/backends.py#L696-L798][the implementation of rchildren for Pennsieve]]
3. [[wt-gh-pull:sparcur/backends.py#L777-L792][looping over packages to covert them to paths]]
4. [[wt-gh-pull:sparcur/monkey.py#L115-L349][transform dataset packages endpoint json into Pennsieve api objects]]
***** Fetch
...
ppp = Path('~/files/sparc-datasets').expanduser()
