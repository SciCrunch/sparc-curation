...
from sparcur import exceptions as exc
from sparcur.utils import log, logd, loge, GetTimeNow
...
class Options(clif.Options):
    ...
    def parent_path(self):
        ...
        if pap:
            ...
            N, thing_type, uuid = id.split(':')  # FIXME N:dataset: vs dataset: vs uuid alone
...
#+begin_src racket :lang racket/base :exports none :tangle ./y-u-no-compile-from-buffer.rkt
...
(struct cluster (label color members))
