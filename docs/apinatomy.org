# -*- mode: org; orgstrap-cypher: sha256; orgstrap-norm-func-name: orgstrap-norm-func--prp-1\.1; orgstrap-block-checksum: d5a47215c1609bce89fe00d933c97cfc8eeecf82bbae89b4ad911fa4eb57f671; -*-
...
(when noninteractive
  (unless user-init-file
    ...
    (setq user-init-file (expand-file-name "orgstrap-init.el" user-emacs-directory))
    (load user-init-file))
  (ow-cli-gen
      ((:install)
       (:all)
