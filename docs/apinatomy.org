# -*- mode: org; orgstrap-cypher: sha256; orgstrap-norm-func-name: orgstrap-norm-func--prp-1\.1; orgstrap-block-checksum: 61100f961a715149202dd37587f63a55d7df5d539ddc7929a439ca51811f6ff7; -*-
  ...
  (when (memq (process-status process) '(exit signal))
    (let ((ex (process-exit-status process))
      ...
      (if (= ex 0)
        ...
        (warn "%s" (with-current-buffer buf (buffer-string)))))))
...
(let ((ghost "https://raw.githubusercontent.com/tgbugs/orgstrap/"))
  (unless (featurep 'ow)
    (reval 'sha256 'd2c7da56f5d59450cbba8fedc71874e2619214a8a4ad78bdee6451e9b6854baa
           (concat ghost "744bc09e19b34b68e458a48beefe61cedba4563c" "/ow.el"))))
