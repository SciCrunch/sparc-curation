# -*- orgstrap-cypher: sha256; orgstrap-norm-func-name: orgstrap-norm-func--dprp-1-0; orgstrap-block-checksum: fe3c5b9edb2d23c291a64ca21f2514a632e090742e1e62bc0dc55d899ce07a65; -*-
...
(defun step-annotations ()
  ...
  (let ((hypothesis-annos "data/annotations.json")
    ...
    (unless (and (file-exists-p hypothesis-annos)
      ...
      (run-command (py-x) "-m" "protcur.cli" "convert" "-f" "prot" hypothesis-annos protcur-path))))
