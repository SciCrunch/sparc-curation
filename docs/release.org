# -*- orgstrap-cypher: sha256; orgstrap-norm-func-name: orgstrap-norm-func--dprp-1-0; orgstrap-block-checksum: a25df01b8f26b9f5657fc711b41481727c5eff14a5ebee6d04c7c8a791c22d47; -*-
...
(defun step-load-store (path-br-bin &optional no-load)
  ...
  (let ((exec-path (cons path-br-bin exec-path))
    ...
    (unless-file-exists-p mis-path
      (url-copy-file (concat rguc "SciCrunch/NIF-Ontology/" ont-git-ref "/ttl/sparc-methods.ttl")
                     mis-path))
    (unless-file-exists-p mis-r-path
      (reason-ontology mis-path mis-r-path))
    (unless-file-exists-p sct-path
      (url-copy-file (concat rguc "SciCrunch/NIF-Ontology/" ont-git-ref "/ttl/sparc-community-terms.ttl")
                     sct-path))
    (unless-file-exists-p sml-path
      (url-copy-file (concat rguc "SciCrunch/NIF-Ontology/" ont-git-ref "/ttl/sparc-missing-labels.ttl")
                     sml-path))
    ...
    (unless-file-exists-p me-path
      ...
      (url-copy-file (concat rguc "SciCrunch/NIF-Ontology/" ont-git-ref "/ttl/methods.ttl") me-path))
