# -*- orgstrap-cypher: sha256; orgstrap-norm-func-name: orgstrap-norm-func--dprp-1-0; orgstrap-block-checksum: 60774e77a09ed34f4d4b71a08a91f5ee6182d4fee8f187dec18172e286aa4cab; -*-
...
(defun step-fetch-blazegraph-runner ()
  ...
  (let* ((url-template "https://github.com/balhoff/blazegraph-runner/releases/download/%s/%s.tgz")
    ...
    (unless (file-directory-p path) ; XXX FIXME if bin/blazegraph-runner gets removed for some reason this check is insufficient
