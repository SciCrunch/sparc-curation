# -*- orgstrap-cypher: sha256; orgstrap-norm-func-name: orgstrap-norm-func--dprp-1-0; orgstrap-block-checksum: 292ff357cc41764a3cd5fa0ea33a0fc6451e85f53091224b3d3cd0b2ba2729c5; -*-
...
(defun step-annos-from-zip (release-zip-path release-dir)
      ...
      (let ((default-directory release-dir))
        ...
        (if no-annos
            (let ((release-zip-path (step-fetch-latest-release-zip build-dir)))
              (step-annos-from-zip release-zip-path release-dir)
              (step-annotations))
          (step-annotations))
