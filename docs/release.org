# -*- orgstrap-cypher: sha256; orgstrap-norm-func-name: orgstrap-norm-func--dprp-1-0; orgstrap-block-checksum: 38f05027db941bf8d5e7ab5d3ee8abb6f7c403373c6f233b809c2e2888748d72; -*-
...
(defun step-annos-from-zip (release-zip-path release-dir &optional do-protcur)
  (let* ((name (file-name-base release-zip-path))
         ...
         (data-dir (expand-file-name "data" release-dir)))
