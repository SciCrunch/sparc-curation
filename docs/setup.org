...
pennsieve: # https://discover.pennsieve.io/user/profile
...
protocols-io:
  api:
    client-token: <rw:token> # https://www.protocols.io/developers
scicrunch:
  api:
    key: <rw:key> # https://scicrunch.org/account/developer
#+end_src
