...
*** Export
    ...
    #+BEGIN_SRC bash
      FULLPATH=$(readlink ~sparc-data-user/files/blackfynn_local/export/N:organization:618e8dd9-f8d2-4dc4-9abb-c6aaab2e78a0/LATEST)
      FOLDERNAME=$(basename $FULLPATH)
      pushd /var/www/sparc/sparc
      cp -a "${FULLPATH}" archive/ && chown -R nginx:nginx archive && unlink exports ; ln -sT "archive/${FOLDERNAME}" exports
      popd
    #+END_SRC
