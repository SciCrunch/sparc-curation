...
* Setup
  ...
  *you are following this guide on you should start at [[#user-start-here][user setup]]*
** One shot
   :PROPERTIES:
   :CUSTOM_ID: one-shot
   :VISIBILITY: folded
...
Update https://github.com/Blackfynn/docs.sparc.science/blob/master/pages/data_submission/submit_data.md
with the new link. [[file:../../docs.sparc.science/pages/data_submission/submit_data.md][Link to the local copy.]]
