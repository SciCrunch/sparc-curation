...
* Variables :noexport:
  ...
  GitHub repositories
  #+NAME: tgbugs-repos
  | augpathlib idlib hyputils ontquery parsercomb pyontutils protc rrid-metadata rkdf orgstrap |
  #+NAME: sci-repos
  ...
  #+NAME: py-roots
  | augpathlib idlib pyontutils/htmlfn pyontutils/ttlser hyputils ontquery parsercomb pyontutils pyontutils/nifstd pyontutils/neurondm protc/protcur sparc-curation scibot |
  #+NAME: rkt-roots
