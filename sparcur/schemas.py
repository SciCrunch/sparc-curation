...
class MetaOutExportSchema(JSONSchema):
    ...
    __schema['properties'].update({
        ...
        'model_of_organ': {'type': 'array',
                           'minItems': 1,
                           'items': {'anyOf': [EIS._allOf(OntTermSchema),
                                               {'type': 'string',},],},
                           'context_value': idtype('TEMP:organModelOf'),},
        'model_of_species': {'type': 'array',
                             'minItems': 1,
                             'items': {'anyOf': [EIS._allOf(OntTermSchema),
                                                 {'type': 'string',},],},
                             'context_value': idtype('TEMP:speciesModelOf'),},
        'collected_from_species': {'type': 'array',
                                   'minItems': 1,
                                   'items': {'anyOf': [EIS._allOf(OntTermSchema),
                                                       {'type': 'string',},],},
                                   'context_value': idtype('TEMP:speciesCollectedFrom'),},
        'template_schema_version': {'type': 'string'},
        'organ': {'type': 'array',
                  'minItems': 1,
